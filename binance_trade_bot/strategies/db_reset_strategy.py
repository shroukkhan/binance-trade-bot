...
class Strategy(AutoTrader):
    def initialize(self):
        self.logger.info(f"Caution: I thought about this for a while now and i decided to remove the gambling strategies from my fork. "
                         f"Its because of many people loosing money and  complaining by me...I added loss hints etc. and still many users"
                         f" decided to blind jump into them. So this strategy uses now the default strategy. The file wil be deleted in the "
                         f"next few days. This fork will concentrade in optimizing the defaults bot with addtional features and settings!")
